(function(factory) {
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        '<style>' +
        '.bootstrap-duallistbox-container .clear1,.bootstrap-duallistbox-container .clear2 {display: none;}' +
        ...
        '</style>' +
        '<div class="bootstrap-duallistbox-container d-flex row">' +
        ' <div class="box1 col-sm">' +
        '   <span class="info-container d-flex justify-content-between p-1">' +
        '     <label style="font-size:11px;"></label>' +
        '     <button type="button" class="btn btn-sm clear1 text-decoration-underline p-0" style="font-size:9px;"></button>' +
        '     <span class="info" style="font-size:11px;"></span>' +
        '   </span>' +
        '   <div class="input-group d-flex flex-column">' +
        '     <input class="form-control filter w-100" style="border-bottom-left-radius:0;border-bottom-right-radius:0;border-top-right-radius:0.375rem;margin-bottom:-1px;margin-left:-1px" type="text">' +
        '     <select class="form-select w-100" style="border-top-left-radius:0;border-top-right-radius:0;border-bottom-left-radius:0.375rem;" multiple="multiple"></select>' +
        '   </div>' +
        ' </div>' +
        ' <div class="buttons d-flex flex-row flex-sm-column justify-content-evenly col-sm-auto py-4 pb-sm-0 px-3 px-sm-0">' +
        '   <button type="button" class="btn btn-outline-secondary btn-sm mx-1 moveall"></button>' +
        '   <button type="button" class="btn btn-outline-secondary btn-sm mx-1 move"></button>' +
        '   <button type="button" class="btn btn-outline-secondary btn-sm mx-1 remove"></button>' +
        '   <button type="button" class="btn btn-outline-secondary btn-sm mx-1 removeall"></button>' +
        ' </div>' +
        ' <div class="box2 col-sm">' +
        '   <span class="info-container d-flex justify-content-between p-1">' +
        '     <label style="font-size:11px;"></label>' +
        '     <button type="button" class="btn btn-sm clear2 text-decoration-underline p-0" style="font-size:9px;"></button>' +
        '     <span class="info" style="font-size:11px;"></span>' +
        '   </span>' +
        '   <div class="input-group d-flex flex-column">' +
        '     <input class="form-control filter w-100" style="border-bottom-left-radius:0;border-bottom-right-radius:0;border-top-right-radius:0.375rem;margin-bottom:-1px;margin-left:-1px" type="text">' +
      ...
      this.elements = {
        ...
        label1: $('.box1 > .info-container > label', this.container),
        label2: $('.box2 > .info-container > label', this.container),
        info1: $('.box1 .info', this.container),
        info2: $('.box2 .info', this.container),
        select1: $('.box1 select', this.container),
        select2: $('.box2 select', this.container),
        moveButton: $('.buttons .move', this.container),
        removeButton: $('.buttons .remove', this.container),
        moveAllButton: $('.buttons .moveall', this.container),
        removeAllButton: $('.buttons .removeall', this.container),
